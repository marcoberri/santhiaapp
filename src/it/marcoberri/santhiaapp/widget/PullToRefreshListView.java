package it.marcoberri.santhiaapp.widget;
...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	 ...
	 * R.layout.pull_to_refresh_header, this, false); mRefreshViewText =
	 * (TextView) mRefreshView .findViewById(R.id.pull_to_refresh_text);
	 * mRefreshViewImage = (ImageView) mRefreshView
	 * .findViewById(R.id.pull_to_refresh_image); mRefreshViewProgress =
	 * (ProgressBar) mRefreshView
	 * .findViewById(R.id.pull_to_refresh_progress); mRefreshViewLastUpdated
