...
public class HomeActivity extends FragmentActivity {
    ...
    public final static LeftListModel[] mMenuTitles = { new LeftListModel("Home", 0, 0), new LeftListModel("Place", 0, 1), new LeftListModel("Carnevale", 0, 2), new LeftListModel("Preferiti", 0, 3), new LeftListModel("Tour", R.drawable.ic_list, 4), new LeftListModel("Eventi", 0, 5)
