...
public class TourModelDataSource {
	...
	final SQLiteDatabase db = helper.getWritableDatabase();
	final Cursor c = db.query(TourModelDBEntry.TABLE_NAME, ALLFIELD, TourModelDBEntry.COLUMN_NAME_COMMUNITY + " = ?", new String[] { (community + "") }, null, null, TourModelDBEntry.COLUMN_NAME_ENTRY_ID);
